...
class ResultDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    id: Field::Number,
    backup_images_with_hash: Field::String.with_options(searchable: false),
    data: Field::String.with_options(searchable: false),
    pooling_station: Field::BelongsTo,
    result_source: Field::BelongsTo,
    screenshoot_url: Field::String,
